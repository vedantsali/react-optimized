...
<head>
    <title>Code coverage report for node_modules1/damerau-levenshtein/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">node_modules1/damerau-levenshtein</a> index.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// TheSpanishInquisition
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (Math.abs(thisLength - thatLength) &gt; (limit || <span class="branch-1 cbranch-no" title="branch not covered" >100)</span>){
<span class="cstat-no" title="statement not covered" >    return prepare (limit || 100);</span>
  }
  if (thisLength === 0){
...
&nbsp;
    ...
    for (j = 1; j &lt;= thatLength; ++j) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (i === j &amp;&amp; matrix[i][j] &gt; 4) <span class="cstat-no" title="statement not covered" >return prepare (thisLength);</span>
&nbsp;
      that_j = that[j-1];
