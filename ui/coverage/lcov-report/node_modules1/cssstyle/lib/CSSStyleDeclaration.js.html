...
<head>
    <title>Code coverage report for node_modules1/cssstyle/lib/CSSStyleDeclaration.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">node_modules1/cssstyle/lib</a> CSSStyleDeclaration.js</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >      return;</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (value === null || value === '') {
<span class="cstat-no" title="statement not covered" >      this.removeProperty(name);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
...
&nbsp;
  getPropertyCSSValue: <span class="fstat-no" title="function not covered" >fu</span>nction() {
    //FIXME
<span class="cstat-no" title="statement not covered" >    return;</span>
  },
&nbsp;
   ...
   *   -&gt; "overflow"
   */
  getPropertyShorthand: <span class="fstat-no" title="function not covered" >fu</span>nction() {
    //FIXME
<span class="cstat-no" title="statement not covered" >    return;</span>
  },
&nbsp;
  isPropertyImplicit: <span class="fstat-no" title="function not covered" >fu</span>nction() {
    //FIXME
<span class="cstat-no" title="statement not covered" >    return;</span>
  },
&nbsp;
  ...
  item: function(index) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (index &lt; 0 || index &gt;= this._length) {
<span class="cstat-no" title="statement not covered" >      return '';</span>
    }
    return this[index];
  },
  ...
  cssText: {
    get: function() {
      ...
      for (i = 0; i &lt; this._length; i++) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (priority !== '') {
<span class="cstat-no" title="statement not covered" >          priority = ' !' + priority;</span>
        }
