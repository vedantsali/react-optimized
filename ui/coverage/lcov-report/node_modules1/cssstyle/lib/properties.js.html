...
<head>
    <title>Code coverage report for node_modules1/cssstyle/lib/properties.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">node_modules1/cssstyle/lib</a> properties.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">71.53% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>402/562</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">43.97% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>124/282</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">65.36% </span>
                <span class="quiet">Functions</span>
                <span class='fraction'>117/179</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">71.48% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>401/561</span>
            </div>
...
<a name='L1834'></a><a href='#L1834'>1834</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
azimuth_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
    var valueType = <span class="cstat-no" title="statement not covered" >external_dependency_parsers_0.valueType(v);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (valueType === external_dependency_parsers_0.TYPES.ANGLE) {</span>
<span class="cstat-no" title="statement not covered" >      return this._setProperty('azimuth', external_dependency_parsers_0.parseAngle(v));</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (valueType === external_dependency_parsers_0.TYPES.KEYWORD) {</span>
      var keywords = <span class="cstat-no" title="statement not covered" >v.toLowerCase().trim().split(/\s+/);</span>
      var hasBehind = <span class="cstat-no" title="statement not covered" >false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (keywords.length &gt; 2) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
      var behindIndex = <span class="cstat-no" title="statement not covered" >keywords.indexOf('behind');</span>
<span class="cstat-no" title="statement not covered" >      hasBehind = behindIndex !== -1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (keywords.length === 2) {</span>
<span class="cstat-no" title="statement not covered" >        if (!hasBehind) {</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        keywords.splice(behindIndex, 1);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (keywords[0] === 'leftwards' || keywords[0] === 'rightwards') {</span>
<span class="cstat-no" title="statement not covered" >        if (hasBehind) {</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return this._setProperty('azimuth', keywords[0]);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (keywords[0] === 'behind') {</span>
<span class="cstat-no" title="statement not covered" >        return this._setProperty('azimuth', '180deg');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      switch (keywords[0]) {</span>
        case 'left-side':
<span class="cstat-no" title="statement not covered" >          return this._setProperty('azimuth', '270deg');</span>
&nbsp;
        case 'far-left':
<span class="cstat-no" title="statement not covered" >          return this._setProperty('azimuth', (hasBehind ? 240 : 300) + 'deg');</span>
&nbsp;
        case 'left':
<span class="cstat-no" title="statement not covered" >          return this._setProperty('azimuth', (hasBehind ? 220 : 320) + 'deg');</span>
&nbsp;
        case 'center-left':
<span class="cstat-no" title="statement not covered" >          return this._setProperty('azimuth', (hasBehind ? 200 : 340) + 'deg');</span>
&nbsp;
        case 'center':
<span class="cstat-no" title="statement not covered" >          return this._setProperty('azimuth', (hasBehind ? 180 : 0) + 'deg');</span>
&nbsp;
        case 'center-right':
<span class="cstat-no" title="statement not covered" >          return this._setProperty('azimuth', (hasBehind ? 160 : 20) + 'deg');</span>
&nbsp;
        case 'right':
<span class="cstat-no" title="statement not covered" >          return this._setProperty('azimuth', (hasBehind ? 140 : 40) + 'deg');</span>
&nbsp;
        case 'far-right':
<span class="cstat-no" title="statement not covered" >          return this._setProperty('azimuth', (hasBehind ? 120 : 60) + 'deg');</span>
&nbsp;
        case 'right-side':
<span class="cstat-no" title="statement not covered" >          return this._setProperty('azimuth', '90deg');</span>
&nbsp;
        default:
<span class="cstat-no" title="statement not covered" >          return;</span>
      }
...
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('azimuth');</span>
  },
  enumerable: true,
  configurable: true
};
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (external_dependency_parsers_0.valueType(v) === external_dependency_parsers_0.TYPES.KEYWORD &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >v.toLowerCase() === 'transparent' </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >v.toLowerCase() === 'inherit')</span>) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (parsed === undefined) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (external_dependency_parsers_0.valueType(v) === external_dependency_parsers_0.TYPES.KEYWORD &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >v.toLowerCase() === 'none' </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >v.toLowerCase() === 'inherit')</span>) {
<span class="cstat-no" title="statement not covered" >    return v;</span>
  }
&nbsp;
  return undefined;
...
var backgroundRepeat_local_var_parse = function parse(v) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (external_dependency_parsers_0.valueType(v) === external_dependency_parsers_0.TYPES.KEYWORD &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >v.toLowerCase() === 'repeat' </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >v.toLowerCase() === 'repeat-x' </span>|| <span class="branch-3 cbranch-no" title="branch not covered" >v.toLowerCase() === 'repeat-y' </span>|| <span class="branch-4 cbranch-no" title="branch not covered" >v.toLowerCase() === 'no-repeat' </span>|| <span class="branch-5 cbranch-no" title="branch not covered" >v.toLowerCase() === 'inherit')</span>) {
<span class="cstat-no" title="statement not covered" >    return v;</span>
  }
&nbsp;
  return undefined;
...
var backgroundAttachment_local_var_isValid = backgroundAttachment_export_isValid = function isValid(v) {
  return external_dependency_parsers_0.valueType(v) === external_dependency_parsers_0.TYPES.KEYWORD &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >v.toLowerCase() === 'scroll' </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >v.toLowerCase() === 'fixed' </span>|| <span class="branch-3 cbranch-no" title="branch not covered" >v.toLowerCase() === 'inherit')</span>;
};
&nbsp;
backgroundAttachment_export_definition = {
  set: function (v) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!backgroundAttachment_local_var_isValid(v)) {
      return;
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._setProperty('background-attachment', v);</span>
  },
  get: function () {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (parts.length === 1) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (types[0] === external_dependency_parsers_0.TYPES.LENGTH || types[0] === external_dependency_parsers_0.TYPES.PERCENT) {
<span class="cstat-no" title="statement not covered" >      return v;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (types[0] === external_dependency_parsers_0.TYPES.KEYWORD) {
<span class="cstat-no" title="statement not covered" >      if (backgroundPosition_local_var_valid_keywords.indexOf(v.toLowerCase()) !== -1 || v.toLowerCase() === 'inherit') {</span>
<span class="cstat-no" title="statement not covered" >        return v;</span>
      }
    }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if ((types[0] === external_dependency_parsers_0.TYPES.LENGTH || types[0] === external_dependency_parsers_0.TYPES.PERCENT) &amp;&amp; (types[1] === external_dependency_parsers_0.TYPES.LENGTH || types[1] === external_dependency_parsers_0.TYPES.PERCENT)) {</span>
<span class="cstat-no" title="statement not covered" >    return v;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (types[0] !== external_dependency_parsers_0.TYPES.KEYWORD || types[1] !== external_dependency_parsers_0.TYPES.KEYWORD) {</span>
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (backgroundPosition_local_var_valid_keywords.indexOf(parts[0]) !== -1 &amp;&amp; backgroundPosition_local_var_valid_keywords.indexOf(parts[1]) !== -1) {</span>
<span class="cstat-no" title="statement not covered" >    return v;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return undefined;</span>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof v !== 'string') {
<span class="cstat-no" title="statement not covered" >    return false;</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (v === '') {
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
&nbsp;
  v = v.toLowerCase();
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (borderWidth_local_var_widths.indexOf(v) === -1) {
    return false;
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return true;</span>
...
var borderWidth_local_var_parser = function (v) {
  var length = external_dependency_parsers_0.parseLength(v);
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (length !== undefined) {
    return length;
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (borderWidth_local_var_isValid(v)) {</span>
...
var borderStyle_local_var_parser = function (v) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (borderStyle_local_var_isValid(v)) {
...
var borderColor_local_var_parser = function (v) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (borderColor_local_var_isValid(v)) {
    return v.toLowerCase();
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return undefined;</span>
...
borderBottomWidth_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    if (borderBottomWidth_local_var_isValid(v)) {</span>
<span class="cstat-no" title="statement not covered" >      this._setProperty('border-bottom-width', v);</span>
    }
  },
  get: function () {
...
borderBottomStyle_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    if (borderStyle_export_isValid(v)) {</span>
<span class="cstat-no" title="statement not covered" >      if (v.toLowerCase() === 'none') {</span>
<span class="cstat-no" title="statement not covered" >        v = '';</span>
<span class="cstat-no" title="statement not covered" >        this.removeProperty('border-bottom-width');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      this._setProperty('border-bottom-style', v);</span>
    }
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('border-bottom-style');</span>
  },
  enumerable: true,
  configurable: true
};
...
borderBottomColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    if (borderBottomColor_local_var_isValid(v)) {</span>
<span class="cstat-no" title="statement not covered" >      this._setProperty('border-bottom-color', v);</span>
    }
  },
  get: function () {
...
&nbsp;
var borderCollapse_local_var_parse = function <span class="fstat-no" title="function not covered" >parse(</span>v) {
<span class="cstat-no" title="statement not covered" >  if (external_dependency_parsers_0.valueType(v) === external_dependency_parsers_0.TYPES.KEYWORD &amp;&amp; (v.toLowerCase() === 'collapse' || v.toLowerCase() === 'separate' || v.toLowerCase() === 'inherit')) {</span>
<span class="cstat-no" title="statement not covered" >    return v;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return undefined;</span>
...
borderCollapse_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('border-collapse', borderCollapse_local_var_parse(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('border-collapse');</span>
  },
  enumerable: true,
  configurable: true
};
...
borderLeftWidth_export_definition = {
  set: function (v) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (borderLeftWidth_local_var_isValid(v)) {
...
<span class="cstat-no" title="statement not covered" >      if (v.toLowerCase() === 'none') {</span>
<span class="cstat-no" title="statement not covered" >        v = '';</span>
<span class="cstat-no" title="statement not covered" >        this.removeProperty('border-left-width');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      this._setProperty('border-left-style', v);</span>
    }
  },
  get: function () {
...
borderLeftColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    if (borderLeftColor_local_var_isValid(v)) {</span>
<span class="cstat-no" title="statement not covered" >      this._setProperty('border-left-color', v);</span>
    }
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('border-left-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
borderRightWidth_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    if (borderRightWidth_local_var_isValid(v)) {</span>
<span class="cstat-no" title="statement not covered" >      this._setProperty('border-right-width', v);</span>
    }
  },
  get: function () {
...
<span class="cstat-no" title="statement not covered" >      if (v.toLowerCase() === 'none') {</span>
<span class="cstat-no" title="statement not covered" >        v = '';</span>
<span class="cstat-no" title="statement not covered" >        this.removeProperty('border-right-width');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      this._setProperty('border-right-style', v);</span>
    }
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('border-right-style');</span>
  },
  enumerable: true,
  configurable: true
};
...
borderRightColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    if (borderRightColor_local_var_isValid(v)) {</span>
<span class="cstat-no" title="statement not covered" >      this._setProperty('border-right-color', v);</span>
    }
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('border-right-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
var borderSpacing_local_var_parse = function parse(v) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (v === '' || v === null) {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (v.toLowerCase() === 'inherit') {</span>
<span class="cstat-no" title="statement not covered" >    return v;</span>
  }
&nbsp;
  var parts = <span class="cstat-no" title="statement not covered" >v.split(/\s+/);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (parts.length !== 1 &amp;&amp; parts.length !== 2) {</span>
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (external_dependency_parsers_0.valueType(part) !== external_dependency_parsers_0.TYPES.LENGTH) {</span>
<span class="cstat-no" title="statement not covered" >      return undefined;</span>
    }
  });
<span class="cstat-no" title="statement not covered" >  return v;</span>
...
borderSpacing_export_definition = {
  ...
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('border-spacing');</span>
  },
  enumerable: true,
  configurable: true
};
...
borderTopWidth_export_definition = {
  set: function (v) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (borderWidth_export_isValid(v)) {
...
borderTopStyle_export_definition = {
  set: function (v) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (borderStyle_export_isValid(v)) {
...
borderTopColor_export_definition = {
  set: function (v) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (borderTopColor_local_var_isValid(v)) {
...
var clip_local_var_parse = function (val) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (val === '' || val === null) {
<span class="cstat-no" title="statement not covered" >    return val;</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof val !== 'string') {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
&nbsp;
  val = val.toLowerCase();
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (val === 'auto' || val === 'inherit') {
<span class="cstat-no" title="statement not covered" >    return val;</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (parts.length !== 4) {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
&nbsp;
...
cssFloat_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('float', v);</span>
  },
  get: function () {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (String(v).toLowerCase() === 'inherit') {
<span class="cstat-no" title="statement not covered" >    return 'inherit';</span>
  }
&nbsp;
...
&nbsp;
flex_export_isValid = function <span class="fstat-no" title="function not covered" >isValid(</span>v) {
<span class="cstat-no" title="statement not covered" >  return external_dependency_parsers_0.shorthandParser(v, flex_local_var_shorthand_for) !== undefined;</span>
};
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (normalizedValue === 'initial') {
<span class="cstat-no" title="statement not covered" >      flex_local_var_myShorthandSetter.call(this, '0 1 auto');</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
...
floodColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('flood-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('flood-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
function fontSize_local_fn_parse(v) {
  ...
  return isOptionalArgument ? <span class="branch-0 cbranch-no" title="branch not covered" >valueAsString </span>: external_dependency_parsers_0.parseMeasurement(v);
}
&nbsp;
...
fontStyle_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('font-style', v);</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('font-style');</span>
  },
  enumerable: true,
  configurable: true
};
...
fontVariant_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('font-variant', v);</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('font-variant');</span>
  },
  enumerable: true,
  configurable: true
};
...
fontWeight_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('font-weight', v);</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('font-weight');</span>
  },
  enumerable: true,
  configurable: true
};
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (short !== undefined) {
      return font_local_var_setter.call(this, v);
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (external_dependency_parsers_0.valueType(v) === external_dependency_parsers_0.TYPES.KEYWORD &amp;&amp; font_local_var_static_fonts.indexOf(v.toLowerCase()) !== -1) {</span>
<span class="cstat-no" title="statement not covered" >      this._setProperty('font', v);</span>
    }
  },
...
lightingColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('lighting-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('lighting-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
&nbsp;
  var type = external_dependency_parsers_0.valueType(v);
  return type === margin_local_var_TYPES.LENGTH || type === margin_local_var_TYPES.PERCENT || type === margin_local_var_TYPES.INTEGER &amp;&amp; (v === '0' || <span class="branch-4 cbranch-no" title="branch not covered" >v === 0)</span>;
};
&nbsp;
...
margin_export_definition = {
  set: function (v) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof v === 'number') {
<span class="cstat-no" title="statement not covered" >      v = String(v);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof v !== 'string') {
<span class="cstat-no" title="statement not covered" >      return;</span>
...
&nbsp;
    switch (V) {
<span class="branch-0 cbranch-no" title="branch not covered" >      case 'inherit':</span>
<span class="branch-1 cbranch-no" title="branch not covered" >      case 'initial':</span>
<span class="branch-2 cbranch-no" title="branch not covered" >      case 'unset':</span>
      case '':
...
opacity_export_definition = {
  ...
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('opacity');</span>
  },
  enumerable: true,
  configurable: true
};
...
outlineColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('outline-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('outline-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
var padding_local_var_isValid = function (v) {
  var type = external_dependency_parsers_0.valueType(v);
  return type === padding_local_var_TYPES.LENGTH || type === padding_local_var_TYPES.PERCENT || type === padding_local_var_TYPES.INTEGER &amp;&amp; (v === '0' || <span class="branch-4 cbranch-no" title="branch not covered" >v === 0)</span>;
};
&nbsp;
...
stopColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('stop-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('stop-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
textLineThroughColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('text-line-through-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('text-line-through-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
textOverlineColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('text-overline-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('text-overline-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
textUnderlineColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('text-underline-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('text-underline-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
webkitBorderAfterColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('-webkit-border-after-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('-webkit-border-after-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
webkitBorderBeforeColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('-webkit-border-before-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('-webkit-border-before-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
webkitBorderEndColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('-webkit-border-end-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('-webkit-border-end-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
webkitBorderStartColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('-webkit-border-start-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('-webkit-border-start-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
webkitColumnRuleColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('-webkit-column-rule-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('-webkit-column-rule-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
webkitMatchNearestMailBlockquoteColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('-webkit-match-nearest-mail-blockquote-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('-webkit-match-nearest-mail-blockquote-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
webkitTapHighlightColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('-webkit-tap-highlight-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('-webkit-tap-highlight-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
webkitTextEmphasisColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('-webkit-text-emphasis-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('-webkit-text-emphasis-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
webkitTextFillColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('-webkit-text-fill-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('-webkit-text-fill-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
webkitTextStrokeColor_export_definition = {
  set: <span class="fstat-no" title="function not covered" >fu</span>nction (v) {
<span class="cstat-no" title="statement not covered" >    this._setProperty('-webkit-text-stroke-color', external_dependency_parsers_0.parseColor(v));</span>
  },
  get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('-webkit-text-stroke-color');</span>
  },
  enumerable: true,
  configurable: true
};
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sun Apr 12 2020 09:51:26 GMT+0530 (India Standard Time)
            </div>
        </div>
